...
class MaxEnt(Classifier):
    ...
    def compute_observation(self, mini_batch):
        ...
        for instance in mini_batch:
            for feature in instance.feature_vector:
                observation[self.labels[instance.label]][feature] += 1
        return observation
    ...
    def compute_estimation(self, mini_batch):
        ...
        for instance in mini_batch:
            for label in self.labels:
                ...
                for feature in instance.feature_vector:
                    estimation[self.labels[label]][feature] += probability
        return estimation
    ...
    def compute_probability(self, label, instance):
        top = sum([self.lambda_weight(label, feature) for feature in instance.feature_vector])
